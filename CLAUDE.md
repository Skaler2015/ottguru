...
| 2 — वेबसाइट | 🔶 शुरू। होमपेज + title पन्ना + platform पन्ना बने और असली MariaDB पर परखे गए। बाक़ी: भाषा पेज, changes पेज, sitemap |
...
- कोड की टिप्पणियाँ और UI **हिंदी में**। Subhash हिंदी/Hinglish में काम करते हैं,
  और साइट भी हिंदी में होगी (JustWatch India लगभग पूरा अंग्रेज़ी में है — यही
  हमारा फ़ायदा)
