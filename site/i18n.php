...
$GLOBALS['__EN'] = [
    ...
    '%d अभी OTT पर'     => '%d on OTT now',
    'ब्राउज़'            => 'Browse',
    'क्या देखें? फ़िल्टर कीजिए' => 'What to watch? Filter it',
    'Browse — फिल्में और सीरीज़ फ़िल्टर कीजिए' => 'Browse — filter movies & series',
    '%s titles इस चुनाव में' => '%s titles in this selection',
    ...
    'रिलीज़ हुई'         => 'Released',
    // title पन्ना — facts / FAQ / share
    'फिल्म के तथ्य'      => 'Movie facts',
    'अक्सर पूछे सवाल'    => 'Frequently asked',
    'शेयर करें'          => 'Share',
    'लिंक कॉपी'          => 'Copy link',
    'कॉपी हो गया ✓'      => 'Copied ✓',
    'यह लिंक कॉपी कीजिए:' => 'Copy this link:',
    '%s कहाँ देखें?'      => 'Where to watch %s?',
    '%s अभी %s पर सब्सक्रिप्शन में उपलब्ध है।' => '%s is currently on %s (subscription).',
    'किराये/ख़रीद पर भी: %s।' => 'Also on rent/buy: %s.',
    '%s अभी भारत में किसी OTT सब्सक्रिप्शन पर उपलब्ध नहीं है।' => '%s is not on any OTT subscription in India right now.',
    'क्या %s %s पर है?'   => 'Is %s on %s?',
    'हाँ, %s अभी %s पर देखी जा सकती है।' => 'Yes, %s can be watched on %s right now.',
    '%s कब रिलीज़ हुई?'   => 'When was %s released?',
    '%s %s को रिलीज़ हुई थी।' => '%s was released on %s.',
    '%s की अवधि कितनी है?' => 'How long is %s?',
    '%s की अवधि लगभग %d मिनट है।' => '%s runs about %d minutes.',
    '%s किन भाषाओं में है?' => 'What languages is %s in?',
    '%s इन भाषाओं में है: %s।' => '%s is available in: %s.',
    'आज'               => 'today',
    'लाइव'             => 'live',
    'अभी %s पर'         => 'Now on %s',
